...
2. **Random Forest**: Random Forest is an ensemble learning algorithm that combines multiple decision trees to make predictions. It can handle complex relationships between variables and can provide feature importance rankings, helping identify which factors contribute most to heart disease risk.
